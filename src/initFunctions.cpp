...
//--------------------------------------------------------------
void ofApp::initComputeShader() {
	compute.setupShaderFromFile(GL_COMPUTE_SHADER, "shaders/compute.glsl");
	compute.linkProgram();
}
...
void ofApp::initGui() {
	...
	roboto = io.Fonts->AddFontFromFileTTF("data/fonts/Roboto-Regular.ttf", 16.f);
	io.Fonts->Build();

	gui.setup();
}

void ofApp::initImGuiStyle() {
